...
@section('content')
        ...
        <div class="pb-5">
          <div class="container">
                    ...
                    <tbody>
                     ...
                     <tr>
                        ...
                        <form action="{{route('cart.destroy', $produit->rowId) }}" method="post">
                          @method('Delete')
                          @csrf
                          <button type="submit" class=" btn btn-danger text-dark" value="delete"><i class="fa fa-trash"></i></button></td>
                        </form>  
                      </tr>
                     @endforeach
                    </tbody>
            ...
            <div class="row py-5 p-4 bg-white rounded shadow-sm">
              ...
              <div class="col-lg-6">
                <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Détaille commande </div>
                <div class="p-4">
    ...
    @else
        <p class=" alert alert-danger text-center"> Votre panier est vide.</p>
    @endif
@endsection